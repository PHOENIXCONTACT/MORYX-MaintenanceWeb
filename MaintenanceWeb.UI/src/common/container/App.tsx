...
const mapStateToProps = (state: IAppState): IAppPropModel => {
    return {
...
class App extends React.Component<IAppPropModel & RouteComponentProps<{}> & IAppDispatchPropModel> {
    ...
    constructor(props: IAppPropModel & RouteComponentProps<{}> & IAppDispatchPropModel) {
        super(props);
...
export default withRouter<RouteComponentProps<{}>>(connect<IAppPropModel, IAppDispatchPropModel>(mapStateToProps, mapDispatchToProps)(App));
